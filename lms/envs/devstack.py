...
IDA_LOGOUT_URI_LIST = [
    ...
    '{protocol}://{domain}:18381/logout/'.format(domain=SERVER_ROOT_DOMAIN, protocol=SERVER_ROOT_PROTOCOL),  # discovery
]
...
ECOMMERCE_PUBLIC_URL_ROOT = '{protocol}://{domain}:18130'.format(domain=SERVER_ROOT_DOMAIN, protocol=SERVER_ROOT_PROTOCOL)
...
CREDENTIALS_PUBLIC_SERVICE_URL = '{protocol}://{domain}:18150'.format(domain=SERVER_ROOT_DOMAIN, protocol=SERVER_ROOT_PROTOCOL)
...
LEARNING_MICROFRONTEND_URL = '{protocol}://{domain}:2000'.format(domain=SERVER_ROOT_DOMAIN, protocol=SERVER_ROOT_PROTOCOL)
ACCOUNT_MICROFRONTEND_URL = '{protocol}://{domain}:1997'.format(domain=SERVER_ROOT_DOMAIN, protocol=SERVER_ROOT_PROTOCOL)
...
MARKETING_SITE_ROOT = os.environ.get('MARKETING_SITE_ROOT', '{protocol}://{domain}:8080'.format(domain=SERVER_ROOT_DOMAIN, protocol=SERVER_ROOT_PROTOCOL))
